...
const Inicio: React.FC = () => {
    ...
    return (
        <>
            ...
            <section className="py-20 px-4 bg-gradient-to-r from-white to-azul-light/20">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-black text-azul mb-6">
                            Síguenos en <span className="text-verdeOscuro">Redes Sociales</span>
                        </h2>
                        <p className="text-xl text-grisOscuro max-w-2xl mx-auto">
                            Mantente conectado con nosotros y descubre contenido exclusivo sobre salud y bienestar
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                        {/* YouTube destacado */}
                        <div className="lg:col-span-2 bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-red-100">
                            <div className="flex items-center mb-6">
                                <div className="w-16 h-16 bg-red-500 rounded-2xl flex items-center justify-center mr-4">
                                    <FaYoutube className="text-white text-2xl" />
                                </div>
                                <div>
                                    <h3 className="text-2xl font-bold text-azul">Canal Red Medicron IPS</h3>
                                    <p className="text-grisOscuro">Videos educativos y testimonios</p>
                                </div>
                            </div>

                            <div className="relative bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-8 text-center hover:from-red-100 hover:to-red-200 transition-all cursor-pointer group">
                                <FaPlay className="text-red-500 text-4xl mx-auto mb-4 group-hover:scale-110 transition-transform" />
                                <h4 className="text-xl font-bold text-red-600 mb-2">Últimos Videos</h4>
                                <p className="text-red-700 mb-4">Charlas educativas, procedimientos y testimonios de pacientes</p>
                                <div className="flex justify-center space-x-4">
                                    ...
                                    <button className="bg-white text-red-500 border border-red-500 hover:bg-red-50 px-6 py-2 rounded-full font-semibold transition-colors">
                                        Suscribirse
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="space-y-6">
                            <a
                                href="https://facebook.com/redmedicronips"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="block bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-blue-100 group"
                            >
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-azul">Facebook</h4>
                                        <p className="text-grisOscuro text-sm">Noticias y actualizaciones</p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="block bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-pink-100 group"
                            >
                                <div className="flex items-center">
                                    <div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-500 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                                        <FaInstagram className="text-white text-xl" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-azul">Instagram</h4>
                                        <p className="text-grisOscuro text-sm">Contenido visual</p>
                                    </div>
                                </div>
                            </a>
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-azul">LinkedIn</h4>
                                        <p className="text-grisOscuro text-sm">Red profesional</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div className="max-w-6xl mx-auto text-center relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                            ...
                            <p className="text-white/80 mb-4">Atención telefónica las 24 horas</p>
                            <a href="tel:+57123456789" className="text-acento font-semibold hover:text-warning transition-colors">
                                +57 123 456 789
                            </a>
                        </div>
                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                            ...
                            <a href="https://wa.me/57123456789" className="text-green-400 font-semibold hover:text-green-300 transition-colors">
                                Enviar mensaje
                            </a>
                        </div>
